...
export default function DiagramQuiebre() {
  return (
    <Frame label="Transparencia, quiebre y sus dos salidas" viewBox="0 0 560 280">
      ...
      <Box x={330} y={40} w={175} h={60} label="Quiebre" sub="algo interrumpe lo que me importa" highlight />
      ...
      <Box x={320} y={190} w={215} h={62} label="Conversaciones que mueven" sub="pedidos, reclamos, declaraciones" highlight />
